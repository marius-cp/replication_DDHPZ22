...
T. Dimitriadis, L. Dümbgen, A. Henzi, M. Puke, and J. Ziegel. Honest calibration assessment for binary outcome predictions. *Preprint*, [*arXiv:2203.04065*](https://arxiv.org/abs/2203.04065), 2022. 


### Associated repository

The package `calibrationband` is available on [The Comprehensive R Archive Network (CRAN)](https://cran.r-project.org/web/packages/calibrationband/index.html) and via [GitHub](https://github.com/marius-cp/calibrationband).
...
The simulation results can be obtained by running the script `simulation.R`. The simulation output necessary to replicate the results in Figures 3 and 4 is provided in `Fig_3.RDS` and `Fig_4.RDS`.
...
The folder `supplement` holds the replication files for the supplement material of our paper.
